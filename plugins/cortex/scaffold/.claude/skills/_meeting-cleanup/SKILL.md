...
|--------|---------------|--------------|-----------------|
| Business Info | `brain/knowledge/strategy.md` | company, product, team | Company context for interpreting discussions |
| Stakeholder Profiles | `brain/stakeholders/<slug>.md` | attendees' names | Communication preferences, roles, decision authority |
| Active PRDs | `brain/knowledge/product/features/*.md` | features discussed | Link action items to active PRDs |
| Previous Meetings | `brain/ingestion/meetings/`, `outputs/meeting-notes/` | same meeting name, same attendees | Carry-over items, open questions from last time |
| Strategy | `brain/knowledge/strategy.md` | strategic pillars, OKRs | Align decisions to strategic context |
| Decisions | `brain/decisions/` | related decisions | Check for conflicts with past decisions |
...
5. **Strategic alignment is noted for each decision** -- tie decisions to strategic pillars from `brain/knowledge/` when relevant
...
- **How I use it:** Flag for `/decide` if significant
...
- **Decisions identified:** Suggest `/decide` for formal documentation
