...
Load if available:
- `brain/stakeholders/<slug>.md` for any recognized attendee — to surface open asks and recent context before summarizing.
...
Save to `outputs/<date>-<meeting-slug>.md`.
...
- "Run `/ingest` on these notes to route decisions and action items into your brain."
