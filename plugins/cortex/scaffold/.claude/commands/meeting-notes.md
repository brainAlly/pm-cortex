---
description: Transform a meeting transcript or notes into structured decisions, action items, and key insights — saved to outputs/ and routed into the brain
...
When this command is invoked, immediately check:

| Source | Files/Folders | Search Terms | What to Extract |
|--------|---------------|--------------|-----------------|
| Related PRDs | `brain/knowledge/product/features/` | feature from meeting | PRD context, decisions already made |
| Stakeholder Profiles | `brain/stakeholders/` | attendees from meeting | Communication style, preferences, concerns |
| Strategy | `brain/knowledge/strategy.md` | feature or decision from meeting | Strategic alignment context |
| Previous Meetings | `brain/ingestion/meetings/` | topic from this meeting | Historical context, related decisions |
...
**Checking:**
- `brain/ingestion/meetings/` for any previous meetings on this topic
- `brain/stakeholders/` for communication style of attendees
- `brain/knowledge/product/features/` for related feature context
- `brain/knowledge/strategy.md` for strategic alignment
...
(I'll use your preferred writing style from brain/style/writing.md)
...
I'll match your preferred style from `brain/style/writing.md`:
...
- Look at stakeholder info in `brain/stakeholders/<slug>.md`
...
I'll automatically:
- Link to related PRDs in `brain/knowledge/product/features/`
- Reference relevant strategy docs in `brain/knowledge/strategy.md`
- Connect to similar past meetings or decisions from `brain/ingestion/meetings/`
- Pull in stakeholder preferences from `brain/stakeholders/`
...
- PRDs in `brain/knowledge/product/features/*.md` (launch dates, milestone dates)
- Previous meeting notes in `brain/ingestion/meetings/` (prior commitments, deadlines)
- Strategy docs in `brain/knowledge/strategy.md` (quarter end dates, OKR deadlines)
...
- [ ] Run /ingest to route decisions and action items into your brain?
...
- When finalized: Archive to `brain/ingestion/meetings/[date]-[topic].md` for brain pipeline
...
**Pulls from:**
- `brain/knowledge/product/features/` - Feature context for meeting
- `brain/stakeholders/` - Communication preferences and concerns
- `brain/knowledge/strategy.md` - Strategic alignment context
- `brain/ingestion/meetings/` - Previous decisions and context
