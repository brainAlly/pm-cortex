...
Load if available:
- `brain/knowledge/strategy.md` — to align OKRs with current priorities and non-goals
- `brain/knowledge/product/metrics.md` — for current baselines when setting Key Result targets
- `templates/okr-template.md` — output structure for the OKR document (if present)

## Workflow

### Step 1: Gather Context

Load `brain/knowledge/strategy.md` for current priorities and non-goals to align OKRs. Load `brain/knowledge/product/metrics.md` for current metric baselines to set realistic Key Result targets. Load `templates/okr-template.md` for the output structure — use it as the base document.
...
Save to `outputs/<date>-okrs-<slug>.md`.
