...
Load if available:
- `brain/hypotheses/<slug>.md` for the feature being launched — to cross-reference known risks against existing hypotheses
...
Save to `outputs/<date>-pre-mortem-<slug>.md`.
...
- "Want me to **route launch-blocking Tigers to `/hypothesize`** as risk hypotheses in your brain?"
