...
## Brain Context (Plan Mode)

Load if available:
- `brain/knowledge/product/roadmap.md` — for current Now/Next/Later state and active features
- `rules/shipping.md` — for team's definition of done and shipping conventions
...
Load `brain/knowledge/product/roadmap.md` for current Now/Next/Later state. Load `rules/shipping.md` for team's definition of done and required shipping gates — these go directly into the Definition of Done block.
...
Save to `outputs/<date>-release-notes-<slug>.md`. Offer to format for different channels (blog post, in-app, email, Slack announcement).
