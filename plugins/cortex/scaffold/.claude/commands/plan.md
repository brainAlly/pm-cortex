...
- `brain/knowledge/users/insights.md`, relevant `brain/knowledge/users/personas.md` / `brain/knowledge/users/segments.md`
- All active `brain/hypotheses/` in the area
- `brain/decisions/` filtered to relevant prior commitments
- `brain/stakeholders/` filtered to people who'd influence or block the plan
- `rules/discovery.md`, `rules/prioritization.md`, `rules/data.md`

## Updates

- A draft `brain/ingestion/adhoc/<date>-plan-<slug>.md` capturing the planning session
- `brain/hypotheses/<slug>.md` — drafts for any value/usability/feasibility/viability/other risk that needs testing (status: `candidate`)
- `brain/decisions/<date>-<slug>.md` — drafts for go/no-go points (status: `pending`)
- `brain/stakeholders/<slug>.md § Open asks` — drafts for the alignment conversations the plan implies
