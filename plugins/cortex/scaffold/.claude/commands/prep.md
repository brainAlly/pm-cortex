...
- `brain/stakeholders/<slug>.md` for each attendee
- `brain/decisions/` filtered to ones affecting them or the topic
- Active `brain/hypotheses/<slug>.md` they care about or own
- Last 3 `brain/ingestion/meetings/<slug>-*.md` with this person or this meeting type
- `brain/knowledge/strategy.md § Tensions` if any tension intersects their concerns
