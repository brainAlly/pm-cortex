...
Load if available:
- `brain/knowledge/strategy.md` — priorities and non-goals to focus the discovery question
- `brain/knowledge/users/insights.md` — existing user evidence to inform brainstorming
- Active `brain/hypotheses/` in the area — carry forward what's already being tested
- `rules/discovery.md` — team's discovery cadence and norms

## Workflow

### Step 1: Understand the Discovery Context

Load `rules/discovery.md` for team-specific discovery cadence and norms before proceeding — it may constrain which phases to run or which experiment types are preferred.
...
Save to `outputs/<date>-discovery-<slug>.md`.
...
- "Want me to **route the critical assumptions to `/hypothesize`** as active hypotheses in your brain?"
