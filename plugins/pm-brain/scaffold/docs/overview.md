...
## What the Unified PM Brain ships with

Beyond the memory architecture, the system includes:

- **45 slash commands** covering the full PM loop — daily planning, PRDs, sprint, strategy, research, analysis, launch, and more. All local to your project directory.
- **8 standalone skills** — OST, market sizing, Porter's Five Forces, lean canvas, pricing strategy, sentiment analysis, user personas, SWOT.
- **7 sub-agents** — engineer, designer, executive, legal, customer voice, skeptic, UXR analyst. Run individually or all at once via `/prd-review-panel`.
- **Style layer** (`brain/style/`) — writing preferences, framework preferences, and thinking patterns. Populated during setup and refined automatically from observing how you edit outputs.
