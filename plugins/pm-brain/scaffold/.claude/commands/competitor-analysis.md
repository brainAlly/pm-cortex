...
Load if available:
- `brain/knowledge/market/landscape.md` — existing market view and known competitors
- `brain/knowledge/market/competitors/` — per-competitor snapshots already in brain
- `brain/knowledge/strategy.md` — positioning and non-goals to anchor differentiation analysis
...
Save to `outputs/<date>-competitive-analysis-<slug>.md`.
...
- "Want me to **update `brain/knowledge/market/`** with new competitive snapshots from this analysis?"
