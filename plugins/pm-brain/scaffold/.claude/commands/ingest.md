...
- Last 3 entries in `brain/ingestion/<shape>/` for pattern comparison

## Updates

- `brain/source/<shape>/<date>-<slug>.md` — immutable copy of the original artifact
- `brain/ingestion/<shape>/<date>-<slug>.md` — observations tagged (observation / interpretation / hypothesis / assumption / decision)
